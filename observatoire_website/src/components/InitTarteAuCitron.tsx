...
export function InitTarteAuCitron() {
  return (
    <Script
      src="/tarteaucitron.min.js"
      onLoad={() => {
        const initParams = {
          privacyUrl:
            '/mentions-legales-et-politique-de-confidentialite' /* Privacy policy url */,
          bodyPosition:
          ...
          useExternalJs:
            false /* If false, the tarteaucitron.js file will be loaded */,
          ...
          partnersList:
            false /* Show the number of partners on the popup/middle banner */,
        }
        console.log('Initiating tarteaucitron', initParams)
        window.tarteaucitron.init(initParams)

        // attempt to add stuff GA4.... not working yet
        window.tarteaucitron.user.gtagUa = 'G-XXXXXXXXX'
